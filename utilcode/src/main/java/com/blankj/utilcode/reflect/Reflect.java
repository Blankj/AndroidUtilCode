package com.blankj.utilcode.reflect;
 ...
 * on("java.lang.String")
 * // Invoke constructors using the newInstance() method:
 * .newInstance("Hello World")
 * // Invoke methods using the method() method:
 * .method("toString")
...
public class Reflect {
     ...
     * <code>method(name, new Object[0])</code>
     *
     ...
     * <p>
     * This is a convenience method for calling
     * <code>newInstance(new Object[0])</code>
     *
     ...
     * If the wrapped object is a {@link Class}, then this will newInstance a new
     * object of that class. If the wrapped object is any other {@link Object},
     * then this will newInstance a new object of the same type.
     * <p>
