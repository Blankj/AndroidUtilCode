...
> - **转换相关→[ConvertUtils.java][convert.java]→[Test][convert.test]**
 ```
bytes2HexString,     :  byteArr与hexString互转
chars2Bytes,         :  charArr与byteArr互转
byte2Size,           :  字节数与unit为单位的size互转
byte2FitSize         :  字节数转合适大小
bytes2Bits,          :  bytes与bits互转
input2OutputStream,  :  inputStream与outputStream互转
inputStream2Bytes,   :  inputStream与byteArr互转
outputStream2Bytes,  :  outputStream与byteArr互转
inputStream2String,  :  inputStream与string按编码互转
outputStream2String, :  outputStream与string按编码互转
bitmap2Bytes,        :  bitmap与byteArr互转
drawable2Bitmap,     :  drawable与bitmap互转
drawable2Bytes,      :  drawable与byteArr互转
...
encryptHmacMD5,    :  HmacMD5加密
encryptHmacSHA1,   :  HmacSHA1加密
encryptHmacSHA224, :  HmacSHA224加密
encryptHmacSHA256, :  HmacSHA256加密
encryptHmacSHA384, :  HmacSHA384加密
encryptHmacSHA512, :  HmacSHA512加密
encryptDES,        :  DES加密
decryptDES,        :  DES解密
encrypt3DES,       :  3DES加密
decrypt3DES,       :  3DES解密
...
getNetWorkType,        :  获取当前的网络类型(WIFI,2G,3G,4G)
 ```
