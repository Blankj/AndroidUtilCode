...
public class BtUtils {
    ...
    public static final int COMPANY_ID_VIVO = 0x0837;

    //https://www.bluetooth.com/specifications/gatt/services
    public static final UUID MESH_PROVISION_SERVICE = toUuid("1827");
    public static final UUID MESH_PROXY_SERVICE = toUuid("1828");

    //https://www.bluetooth.com/specifications/mesh-specifications/mesh-characteristics
    public static final UUID MESH_PROVISION_IN_CHAR = toUuid("2ADB");
    public static final UUID MESH_PROVISION_OUT_CHAR = toUuid("2ADC");
    public static final UUID MESH_PROXY_IN_CHAR = toUuid("2ADD");
    public static final UUID MESH_PROXY_OUT_CHAR = toUuid("2ADE");

    //https://www.bluetooth.com/specifications/assigned-numbers/generic-access-profile
    private static final int AD_TYPE_PB_ADV = 0x29;
    private static final int AD_TYPE_MESH_MESSAGE = 0x2A;
    private static final int AD_TYPE_MESH_BEACON = 0x2B;
    private static final int AD_TYPE_URI = 0x24;

    public static final UUID VIVO_SERVICE= toUuid("00002760-08c2-11e1-9073-0e8ac72e1011");
    public static final UUID VIVO_CHAR_WRITE= toUuid("00002760-08c2-11e1-9073-0e8ac72e0011");
    public static final UUID VIVO_CHAR_NOTIFY= toUuid("00002760-08c2-11e1-9073-0e8ac72e0012");
    public static final UUID VIVO_CHAR_WRITE_NO_RSP= toUuid("00002760-08c2-11e1-9073-0e8ac72e0013");
//    public static final UUID VIVO_SERVICE= MESH_PROVISION_SERVICE;
//    public static final UUID VIVO_CHAR_WRITE= MESH_PROVISION_IN_CHAR;
//    public static final UUID VIVO_CHAR_NOTIFY= MESH_PROVISION_OUT_CHAR;

    public static final UUID ALIPAY_SERVICE= toUuid("00003802-0000-1000-8000-00805f9b34fb");
    public static final UUID ALIPAY_CHAR_NOTIFY= toUuid("00004a02-0000-1000-8000-00805f9b34fb");
